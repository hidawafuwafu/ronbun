...
STARBUCKSは，自社のコーヒー豆の紹介をメインにしており，抽出に関しては，複数の器具の説明を図と文字でしている\cite{Railshon4}．
...
河原（2018）の，音声認識の方法論の変遷を表として，表\ref{tb:onsei}に示す\cite{Railshon8}．
...
宗定(2014)の記事を元に作成した「seramic.js」\cite{Railshon9},
